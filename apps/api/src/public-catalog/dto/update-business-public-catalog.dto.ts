...
export class UpdateBusinessPublicCatalogDto {
  @ApiPropertyOptional({ description: 'Slug del catálogo público', example: 'mi-catalogo-2026' })
  @IsOptional()
  ...
  @ApiPropertyOptional({ description: 'Indica si el catálogo es visible al público', example: true })
  @IsOptional()
  @IsBoolean()
